...
import {
    ...
    Card, CardHeader, CardContent, Stack, Tooltip, alpha
} from '@mui/material';
import {
    ...
    Bookmark as BookmarkIcon, Security as SecurityIcon
                        ...
                        <CardHeader
                            title={
                                <Box sx={{ display: 'flex', alignItems: 'center' }}>
                                    <BookmarkIcon sx={{ mr: 1, color: 'primary.main', fontSize: 20 }} />
                                    <Typography variant="subtitle1" sx={{ fontWeight: 600, color: 'primary.main', fontSize: 14 }}>
                                        Danh sách vai trò
                                    </Typography>
                                </Box>
                            }
                        ...
                        >
                            {roles.length === 0 ? (
                                <Box sx={{ p: 4, textAlign: 'center', color: 'text.secondary' }}>
                                    <VisibilityOffIcon sx={{ fontSize: 40, opacity: 0.5, mb: 2 }} />
                                    <Typography variant="body2">Chưa có vai trò nào được tạo</Typography>
                                </Box>
                            ) : (
                                roles.map((role) => (
                                    <ListItem
                                    ...
                                    >
                                        <ListItemButton
                                            ...
                                            sx={{
                                                ...
                                                borderColor: selectedRole && selectedRole._id === role._id 
                                                    ? role.color 
                                                    : 'transparent',
                                                transition: 'all 0.2s',
                                                '&.Mui-selected': {
                                        ...
                                        >
                                            ...
                                            <ListItemText
                                                primary={
                                                    <Typography 
                                                        fontWeight="500" 
                                                        color={selectedRole && selectedRole._id === role._id 
                                                            ? 'primary.main' 
                                                            : 'text.primary'
                                                        }
                                                        sx={{ fontSize: 13 }}
                            ...
                            title={
                                <Box sx={{ display: 'flex', alignItems: 'center' }}>
                                    {selectedRole ? (
                                        ...
                                        <SecurityIcon sx={{ mr: 1.5, color: 'primary.main', fontSize: 22 }} />
                                    )}
                                    <Typography variant="subtitle1" sx={{ fontWeight: 600, color: 'primary.main', fontSize: 14 }}>
                                        {selectedRole ? (
                                            <>
                            ...
                            action={
                                <Stack direction="row" spacing={1}>
                                    ...
                                    <Button
                                        ...
                                        onClick={() => selectedRole && handleSaveRolePermission(selectedRole._id)}
                        ...
                        <Box sx={{
                            ...
                            {!selectedRole ? (
                                ...
                                >
                                    ...
                                    <Typography align="center" sx={{ maxWidth: 400, mt: 1, fontSize: 13 }}>
                                        Chọn một vai trò từ danh sách bên trái để xem và quản lý quyền
                                    </Typography>
                                </Box>
                            ) : (
                                <List sx={{
                                                ...
                                                return (
                                                    <ListItem
                                                        ...
                                                        sx={{
                                                            ...
                                                            py: 0.5,
                                                            '&:hover': {
                                                                bgcolor: alpha(selectedRole?.color || '#3f51b5', 0.03)
                                                            }
                                                        }}
                                                        secondaryAction={
                                                            <IconButton
                                                                ...
                                                                <Box>
                                                                    <Typography
                                                                        ...
                                                                        sx={{ 
                                                                            ...
                                                                            color: isChecked ? (selectedRole?.color || 'primary.main') : 'text.primary',
                                                                            fontSize: 13
                                                                        }}
                                                                    >
                                                                        {permission.name}
